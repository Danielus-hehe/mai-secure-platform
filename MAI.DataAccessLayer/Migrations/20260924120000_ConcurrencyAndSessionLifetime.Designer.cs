...
namespace MAI.DataAccessLayer.Migrations
{
    ...
    [Migration("20260924120000_ConcurrencyAndSessionLifetime")]
    partial class ConcurrencyAndSessionLifetime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MAI.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("DirectoryPasswordSetAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("DirectorySyncedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("KeysWrappedAt")
                        .HasColumnType("timestamp with time zone");
