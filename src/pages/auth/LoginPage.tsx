...
export default function LoginPage() {
    ...
    return (
        ...
        bg-gradient-to-br from-mai-900 via-mai-800 to-mai-950 relative overflow-hidden">
          ...
          border-[30px] border-gold-500/10" />

                <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gold-500 flex items-center
            justify-center text-mai-900 font-bold">MAI</div>
                ...
                <p className="text-mai-400 text-xs">
                    © 2025 Ministerul Afacerilor Interne · Acces exclusiv în rețeaua intranet
                </p>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 bg-mai-50">
                <div className="w-full max-w-md">
                    <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
                        <div className="w-11 h-11 rounded-full bg-gold-500 flex items-center
              justify-center text-mai-900 font-bold text-sm">MAI</div>
                    ...
                    <div className="bg-white rounded-2xl shadow-card p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="relative">
                                <User size={16} className="absolute left-3.5 top-[42px] text-mai-300" />
                                <div className="pl-9">
                            ...
                            <div className="relative">
                                <Lock size={16} className="absolute left-3.5 top-[42px] text-mai-300" />
                                <button type="button" onClick={() => setShowPassword((v) => !v)}
                                        className="absolute right-3.5 top-[42px] text-mai-300 hover:text-mai-500">
                                    {showPassword ? <EyeOff size={16} /> : <Eye size={16} />}
                                </button>
                                <div className="pl-9 pr-10">
                                    <Input id="password" label="Parolă" type={showPassword ? 'text' : 'password'}
                  ...
                  rounded-lg px-3.5 py-2.5">{error}</p>
                            )}
