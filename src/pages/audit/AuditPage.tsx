...
export default function AuditPage() {
    ...
    const handleExport = () => {
        toast.success(`Raport de audit exportat — ${filtered.length} înregistrări incluse.`);
    };
            ...
            <div className="bg-white rounded-xl shadow-card border border-mai-100/50 overflow-hidden">
                {filtered.length === 0 ? (
                    <div className="py-14 text-center">
                        ...
                        <p className="text-sm font-medium text-mai-400">Nicio înregistrare pentru filtrele selectate.</p>
                    </div>
                ) : (
