...
Write-Host '  Migrari EF:      dotnet ef migrations list --project MAI.DataAccessLayer --startup-project MAI.Api'
Write-Host ''
...
Write-Host '  Docker:      copiati-o in DB_CONTAINER_CONNECTION_STRING'
